...
<body>
                        ...
                        <div class="col-xs-12">
                            <div class="col-sm-6">
                                <div class="js-card">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table-dashboard table-condensed" >
                                            <thead>
                                                <tr>
                                                    <th>Oportunidad</th>
                                                    <th>Actividad</th>
                            ...
                            <div class="col-sm-6">
                                <div class="js-card">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table-dashboard-inv table-condensed">
                                            <tbody>
                                                <tr>
                                                    <td>Documento 01</td>
                                                    <td>PDF</td>
    ...
    <script src="<?php echo RUTA_JS?>general.js"></script>

    <script src="<?php echo RUTA_PLUGINS?>highchartTable/jquery.highchartTable.js"></script>
